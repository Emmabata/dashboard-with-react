...
import bata from "../assets/BataPIC.jpg"
import CicularProgress from "../Components/CircularProgress/CircularProgress";
...
const Content = () => {
    ...
    // const [value_iii_offset] = useState(315 - (value_i / 100) * 315)
    ...
    return ( 
        ...
        <div className="row header">
            ...
            <svg
                ...
                style={{ fill: '#ffffff', width: '133%', height: 80 }}
            >
                <path
        ...
        <div className="row header">
            ...
            value="+ 0" /> 
            <Card Icon={IoCashOutline} title="Followers" 
            value="$ 0.0" /> 
        ...
        <svg
                ...
                viewBox="0 0 1200 120"
                xmlns="http://www.w3.org/2000/svg"
                style={{ fill: '#ffffff', width: '133%', height: 100,  transform: "rotate(180deg)" , }}
            >
                <path
                d="M0 0v46.29c47.79 22.2 103.59 32.17 158 28 70.36-5.37 136.33-33.31 206.8-37.5 73.84-4.36 147.54 16.88 218.2 35.26 69.27 18 138.3 24.88 209.4 13.08 36.15-6 69.85-17.84 104.45-29.34C989.49 25 1113-14.29 1200 52.47V0z"
                opacity=".25"
        ...
        <div className="row square">
        <Analytics title="New Followers" value="+ o" 
        illustration={img} />
        </div>
        ...
        <div className="row tall-square inv-bg" style={{ position: 'relative' }}>
        <svg
                className="bg-waves__"
                preserveAspectRatio="none"
                viewBox="0 0 1200 120"
                xmlns="http://www.w3.org/2000/svg"
                style={{ fill: '#ffffff', width: '153%', height: 300, }}
            >
                <path
                d="M0 0v46.29c47.79 22.2 103.59 32.17 158 28 70.36-5.37 136.33-33.31 206.8-37.5 73.84-4.36 147.54 16.88 218.2 35.26 69.27 18 138.3 24.88 209.4 13.08 36.15-6 69.85-17.84 104.45-29.34C989.49 25 1113-14.29 1200 52.47V0z"
                opacity=".25"
            ...
            <div className="admin">
                ...
                <div className="info">
                    <h2 className="admin-name">Bata's profile</h2>
                    <span className="admin-about">Full-Stack & Technical writer</span>
                </div>
            ...
            <section>
                ...
                <div className="summary">
                    ...
                    <span className="summary-info">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos dolor ea adipisci deleniti qui minima odio molestiae rem temporibus nulla.
                    </span>
                </div>
        ...
        <div className="row side-rect">
            ...
            <CircularProgress 
                ...
                <div className="more-details">
                    ...
                    <span className="txt"> 
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum doloremque voluptatem ipsa facilis sunt rerum, a, accusantium dolorem cupiditate voluptatibus aspernatur?  
                    </span>
                </div>
            </section>
        </div>
        ...
        <CircularProgress 
                ...
                <div className="more-details">
                    <h1 className="title">Statistical Report</h1>
                    <span className="txt"> 
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum doloremque voluptatem ipsa facilis sunt rerum, a, accusantium dolorem cupiditate voluptatibus aspernatur?  
                    </span>
                </div>
